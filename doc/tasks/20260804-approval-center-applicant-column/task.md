...
- [x] M5：完成本机真实页面只读 E2E，验证四个审批视图的“申请人”列。
...
实现、定向验证、evidence validator、cleanup apply、本地提交、真实页面只读 E2E 和 `git -c http.https://github.com.proxy=http://127.0.0.1:8902 push origin int_main` 均已完成；`int_main` 已同步到 `origin/int_main`，任务完成。
