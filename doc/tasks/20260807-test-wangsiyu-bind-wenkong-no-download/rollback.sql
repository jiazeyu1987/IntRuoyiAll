DROP PROCEDURE IF EXISTS codex_20260807_rollback_wangsiyu_wenkong_no_download;
DELIMITER $$
CREATE PROCEDURE codex_20260807_rollback_wangsiyu_wenkong_no_download()
proc: BEGIN
    DECLARE v_user_id BIGINT;
    DECLARE v_role_id BIGINT;
    DECLARE v_count INT DEFAULT 0;
    DECLARE v_actor VARCHAR(64) DEFAULT 'codex-20260807-wangsiyu-wenkong-no-download-rollback';
    ...
    UPDATE system_user_role
     ...
     WHERE tenant_id = 1
       ...
       AND creator = 'codex-20260807-wangsiyu-wenkong-no-download'
       AND deleted = b'0';
    IF ROW_COUNT() <> 1 THEN
...
END$$
DELIMITER ;
CALL codex_20260807_rollback_wangsiyu_wenkong_no_download();
DROP PROCEDURE codex_20260807_rollback_wangsiyu_wenkong_no_download;
