...
- 计划新增：5 个任务自有生产任务和 5 个 OPEN 记录本；随后由真实一线生产页面生成 5 条生产来源事件，再由真实一线 PQC 页面提交既有的 5 条 FINAL PENDING 任务。
- 正式来源：tenant 1 工单 `980022..980026`、活跃订单 `35..39`、路线 `980091/V622`、路线工序 `980631/922985`、发布 QA 规程版本 `36`、PQC 任务 `198/202/206/210/214`。
