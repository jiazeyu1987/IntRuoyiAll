-- Valid only before any task-owned production or PQC frontend event has been created.
...
BEGIN
    ...
    DELETE FROM mes_pro_edhr_recordbook
     WHERE tenant_id=1 AND deleted=b'0' AND creator='CODX-PQC-20260807' AND entry_count=0;
