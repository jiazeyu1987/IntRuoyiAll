...
- GREEN: `task_closeout.py --task-id 20260805-ac-m23-release-owner-compliance --mode preview` -> keep core records, delete only temporary evidence files, no blockers/warnings.
- GREEN: `task_closeout.py --task-id 20260805-ac-m23-release-owner-compliance --mode apply` -> applied cleanup and retained only `task.md`, `execution-log.md`, and `verification-report.md`.
