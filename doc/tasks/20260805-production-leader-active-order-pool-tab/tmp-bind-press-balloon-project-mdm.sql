...
BEGIN
  DECLARE v_target_name VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT CONVERT(UNHEX('E68C89E58E8BE5BC8FE79083E59B8AE689A9E58585E58E8BE58A9BE6B3B5') USING utf8mb4);
  DECLARE v_source_name VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT CONVERT(UNHEX('E79083E59B8AE689A9E5BCA0E58E8BE58A9BE6B3B5') USING utf8mb4);
  ...
  DECLARE v_project_code VARCHAR(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'IDI';
  DECLARE v_expected_mdm_product_id BIGINT DEFAULT 14;
  DECLARE v_mdm_route_remark VARCHAR(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT CONVERT(UNHEX('514120E8A784E7A88BE6898BE58AA8E7BB91E5AE9A') USING utf8mb4);
  ...
  DECLARE v_snapshot_products_type VARCHAR(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL;
