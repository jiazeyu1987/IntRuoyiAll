...
读取 `C:\Users\BJB110\Desktop\文档\压力泵工序.xlsx` 的 `二代压力泵` 工作表，确认 MES 工序、对外批记录工序、设备、工序编码和产能之间的业务含义，并把本次线程新增口径继续写入现有项目构想与证据文档。
...
- 用户后续明确只分析 `二代压力泵` 工作表，已删除一代压力泵相关待确认项。
