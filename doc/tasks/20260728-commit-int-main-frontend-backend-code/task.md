...
- 四次提交钩子 `branch-runtime-port-guard` 均通过：`int_main/int_main frontend 8081, backend 48081`。
- 提交后复扫：`int_main...origin/int_main [ahead 1]`，仅剩无关并发任务文档 `doc/tasks/20260728-batch-record-product-name-dropdown/*` 未暂存，以及本任务收尾文档待提交。
