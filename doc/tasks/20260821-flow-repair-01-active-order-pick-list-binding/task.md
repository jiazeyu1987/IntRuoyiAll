...
流程1代码已融合当前 `int_main` 并完成主线验证，最新主线 HEAD 为 `1bc0be23e8665485456265b4e92ef78a7154c1f2`：加入时选择并绑定正式领料单，保存头/全量明细快照和 hash，批次/追溯消费者通过绑定关系读取。流程4、6、7、8、9、10、11仍只按邻接契约交接，不在本任务宣称完成。
