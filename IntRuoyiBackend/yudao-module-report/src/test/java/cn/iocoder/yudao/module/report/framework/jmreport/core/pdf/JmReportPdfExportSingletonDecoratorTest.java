...
class JmReportPdfExportSingletonDecoratorTest {

    @Test
    void afterSingletonsInstantiated_shouldDecorateAlreadyInitializedJimuController() throws Exception {
        ...
        beanFactory.addBean("thirdPartyDesignReportController", controller);
        RecordingFontRegistry fontRegistry = new RecordingFontRegistry();

        new JmReportPdfExportSingletonDecorator(beanFactory, new JmReportPdfExportFieldDecorator(fontRegistry))
