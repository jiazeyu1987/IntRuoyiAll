...
- Source facts limited to the user-provided profile for product_002.
- Included only product name, product type, lifecycle, intended use, valve-direction statement, and registration details that were explicitly provided.
- Avoided adding unsupported parameters, structure details, clinical conclusions, or extra registration claims.
