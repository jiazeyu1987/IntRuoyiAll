...
public interface ErrorCodeConstants {
    ...
    // ========== AI TTS 娴嬭瘯 1-040-012-000 ==========
    ErrorCode TTS_TEST_TARGET_NOT_CONFIGURED = new ErrorCode(1_040_012_000, "TTS 测试失败，内部语音模型未正确配置");
    ErrorCode TTS_TEST_TARGET_UNREACHABLE = new ErrorCode(1_040_012_001, "TTS 测试失败，语音服务不可达：{}");
    ErrorCode TTS_TEST_REQUEST_FAILED = new ErrorCode(1_040_012_002, "TTS 测试失败，语音生成异常：{}");
    ErrorCode TTS_TEST_AUDIO_EMPTY = new ErrorCode(1_040_012_003, "TTS 测试失败，未返回音频数据");
    ErrorCode TTS_TEST_VOICE_UNSUPPORTED = new ErrorCode(1_040_012_004, "TTS 测试失败，不支持的音色：{}");
