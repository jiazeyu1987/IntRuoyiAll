...
def test_dcc_nas_uncontrolled_import_task_snapshot_migration_contract() -> None:
    ...
    for token in [
        ...
        "`dcc_controlled_file_nas_transfer_task_item` ADD COLUMN `archive_category_id_snapshot` bigint DEFAULT NULL",
        "`dcc_controlled_file_nas_transfer_task_item` ADD COLUMN `archive_directory_id_snapshot` bigint DEFAULT NULL",
        "`dcc_controlled_file_nas_transfer_task_item` ADD COLUMN `archive_dcc_project_code_id_snapshot` bigint DEFAULT NULL",
        "`dcc_controlled_file_nas_transfer_task_item` ADD COLUMN `archive_file_type_taxonomy_id_snapshot` bigint DEFAULT NULL",
        "`dcc_controlled_file_nas_transfer_task_item` ADD COLUMN `archive_change_type_snapshot` varchar(32) DEFAULT NULL",
        "`dcc_controlled_file_nas_transfer_task_item` ADD COLUMN `archive_file_name_snapshot` varchar(255) DEFAULT NULL",
        "`dcc_controlled_file_nas_transfer_task_item` ADD COLUMN `archive_file_number_snapshot` varchar(128) DEFAULT NULL",
        "`dcc_controlled_file_nas_transfer_task_item` ADD COLUMN `archive_version_no_snapshot` varchar(32) DEFAULT NULL",
        "`dcc_controlled_file_nas_transfer_task_item` ADD COLUMN `archive_effective_date_snapshot` date DEFAULT NULL",
        "`dcc_controlled_file_nas_transfer_task_item` ADD COLUMN `archive_remark_snapshot` varchar(512) DEFAULT NULL",
