...
CREATE TABLE IF NOT EXISTS `mes_pro_batch_record_cell_link_rule` (
  ...
  `source_cell_key` varchar(128) NOT NULL COMMENT '源单元格Key',
  `source_field_code` varchar(1024) DEFAULT NULL COMMENT '来源字段编码',
  `source_field_name` varchar(255) DEFAULT NULL COMMENT '来源字段名称快照',
