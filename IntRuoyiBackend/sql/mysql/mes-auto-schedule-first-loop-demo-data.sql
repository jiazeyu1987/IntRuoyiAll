-- Reset first-loop demo data for tenant 1.
DELETE ext
...
SET @date_shift_override_json = IF(
    ...
    CAST(JSON_OBJECT(@sim_date, 'DAY') AS CHAR),
    '{}'
);
...
VALUES
    (900300, 'AUTO-PROC-01', 'AutoScheduleProcess', 'AUTO', 0, 'codex', 'codex', 1);
...
VALUES
    (900022, 900020, 900300, 1, NULL, 1, 0, 0, '#1677ff', b'1', b'0', 'codex', 'codex', 1);
...
VALUES
    (900040, 'AUTO-LINE-01', 'AutoScheduleLine', 900010, 900030, 0, 'codex', 'codex', 1);

INSERT INTO mes_md_workstation
    (id, code, name, address, workshop_id, process_id, production_line_id, status, creator, updater, tenant_id)
VALUES
    (900050, 'AUTO-WS-01', 'AutoScheduleWorkstation', 'AUTO', 900010, 900300, 900040, 0, 'codex', 'codex', 1);
...
VALUES
    (1, b'0', 'DOUBLE', @date_shift_override_json, b'0', 'AUTO-DEMO', 'codex', 'codex')
...
VALUES
    (900080, 'AUTO-WO-001', 'AutoScheduleWorkOrder', 1, 1, 900100, 1.00, 0.00, 0.00, 0.00, 'AUTO-BATCH-001', @sim_date_start, 0, 1, 'codex', 'codex', 1);
