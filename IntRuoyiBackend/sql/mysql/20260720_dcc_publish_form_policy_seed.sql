-- release-migration: allowedEnvironments=test,backup,prod; dependsOn=20260717_bpm_form_center,20260719_dcc_obsolete_form_policy_seed; type=data; riskLevel=medium
SET NAMES utf8mb4;
...
BEGIN
  IF NOT EXISTS (
    ...
    SIGNAL SQLSTATE '45000'
      SET MESSAGE_TEXT = 'DCC publish form policy requires bpm_form_action_policy';
  END IF;
