-- release-migration: allowedEnvironments=test,backup,prod; dependsOn=20260812_mes_process_pool_b04091_cleaning_temperature_label; type=data; riskLevel=low
-- Rename only the B09353 cleaning-process room-temperature label to the business wording.
...
DROP PROCEDURE IF EXISTS preflight_mes_pp_b09353_cleaning_temperature_label;
DELIMITER $$
...
BEGIN
  IF (
    ...
    SIGNAL SQLSTATE '45000'
      SET MESSAGE_TEXT = 'Missing MES B09353 cleaning temperature dependency table';
  END IF;
...
CALL preflight_mes_pp_b09353_cleaning_temperature_label();
...
SET
  ...
  rule.`updater` = '20260812_b09353_cleaning_temperature_label',
