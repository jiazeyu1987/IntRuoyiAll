-- release-migration: allowedEnvironments=test,backup,prod; dependsOn=20260618_showroom_publicity_role_menu_scope; type=schema; riskLevel=medium
-- Ensure showroom keyword schema and tenant seed data exist in runtime-scanned SQL roots.
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='展厅关键词中英对照';
