-- release-migration: allowedEnvironments=test,backup,prod; dependsOn=20260626_showroom_keyword_schema_seed_runtime; type=seed; riskLevel=low
-- Add BU keyword bilingual rows for runtime-scanned showroom keyword seed.
