...
-- Ensure showroom keyword menu exists in the live MySQL runtime
-- migration-id: 20260625_showroom_keyword_menu_visibility
...
SET `name` = '关键词中英对照',
    ...
    `component_name` = 'ShowroomAdminKeyword',
    `status` = 0,
    `visible` = b'1',
    `keep_alive` = b'1',
    `always_show` = b'1',
