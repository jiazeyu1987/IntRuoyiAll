...
BEGIN
  ...
  INSERT INTO tmp_dcc_view_matrix_seed_category
    (category_code, file_name, matrix_group, matrix_sort, file_number_pattern, lifecycle_stage)
  VALUES
('DCC_FVM_DHF_001', '市场调研报告', 'DHF', 1, 'R&D-项目代码-xxx', 'INPUT'),
('DCC_FVM_DHF_002', '技术调研报告', 'DHF', 2, 'R&D-项目代码-xxx', 'INPUT'),
('DCC_FVM_DHF_003', '临床注册路径分析', 'DHF', 3, 'R&D-项目代码-xxx', 'INPUT'),
('DCC_FVM_DHF_004', '项目立项书', 'DHF', 4, 'R&D-项目代码-xxx', 'PLAN'),
('DCC_FVM_DHF_005', '项目策划书', 'DHF', 5, 'R&D-项目代码-xxx', 'PLAN'),
('DCC_FVM_DHF_006', '专利检索与分析报告', 'DHF', 6, 'R&D-项目代码-xxx', 'INPUT'),
('DCC_FVM_DHF_007', '同类产品测试方案、报告', 'DHF', 7, 'R&D-项目代码-xxx', 'INPUT'),
('DCC_FVM_DHF_008', '不良事件调研报告', 'DHF', 8, 'R&D-项目代码-xxx', 'INPUT'),
('DCC_FVM_DHF_009', '法规、标准清单', 'DHF', 9, '', 'INPUT'),
('DCC_FVM_DHF_010', '风险管理计划', 'DHF', 10, 'RM-项目代码-xxx', 'PLAN'),
('DCC_FVM_DHF_011', '风险管理报告', 'DHF', 11, 'RM-项目代码-xxx', 'OUTPUT'),
('DCC_FVM_DHF_012', '验证主计划', 'DHF', 12, '', 'VERIFICATION'),
('DCC_FVM_DHF_013', '设计验证方案', 'DHF', 13, 'VER-项目代码-xxxa', 'VERIFICATION'),
('DCC_FVM_DHF_014', '设计验证报告', 'DHF', 14, 'VER-项目代码-xxxb', 'VERIFICATION'),
('DCC_FVM_DHF_015', '通用验证方案', 'DHF', 15, 'VER-CR-XXXa', 'VERIFICATION'),
('DCC_FVM_DHF_016', '通用验证报告', 'DHF', 16, 'VER-CR-XXXb', 'VERIFICATION'),
('DCC_FVM_DHF_017', '运输包装验证方案/报告', 'DHF', 17, '', 'VALIDATION'),
('DCC_FVM_DHF_018', '货架寿命验证方案/报告', 'DHF', 18, '', 'VALIDATION'),
('DCC_FVM_DHF_019', '设计转移方案/报告', 'DHF', 19, '', 'TRANSFER'),
('DCC_FVM_DHF_020', '性能评价方案和报告', 'DHF', 20, '', 'VALIDATION'),
('DCC_FVM_DHF_021', '产品过程确认主计划', 'DHF', 21, 'PV-项目代码', 'VALIDATION'),
('DCC_FVM_DHF_022', '设备安装确认（IQ）方案', 'DHF', 22, 'PV-设备编号-A-IQ', 'VALIDATION'),
('DCC_FVM_DHF_023', '设备安装确认（IQ）报告', 'DHF', 23, 'PV-设备编号-B-IQ', 'VALIDATION'),
('DCC_FVM_DHF_024', '过程运行确认（OQ）方案', 'DHF', 24, 'PV-项目代码-XXXa-OQ', 'VALIDATION'),
('DCC_FVM_DHF_025', '过程运行确认（OQ）报告', 'DHF', 25, 'PV-项目代码-XXXb-OQ', 'VALIDATION'),
('DCC_FVM_DHF_026', '过程性能确认（PQ）方案', 'DHF', 26, 'PV-项目代码-XXXa-PQ', 'VALIDATION'),
('DCC_FVM_DHF_027', '过程性能确认（PQ）报告', 'DHF', 27, 'PV-项目代码-XXXb-PQ', 'VALIDATION'),
('DCC_FVM_DHF_028', '过程确认总结报告', 'DHF', 28, 'PV-项目代码-XXXb', 'VALIDATION'),
('DCC_FVM_DHF_029', '灭菌确认方案/报告', 'DHF', 29, '', 'VALIDATION'),
('DCC_FVM_DHF_030', '首次注册资料汇编', 'DHF', 30, 'IR-项目代码-XXX', 'TRANSFER'),
('DCC_FVM_DHF_031', '延续注册资料汇编', 'DHF', 31, 'ER-项目代码-XXX', 'TRANSFER'),
('DCC_FVM_DHF_032', '变更注册资料汇编', 'DHF', 32, 'AR-项目代码-XXX', 'TRANSFER'),
('DCC_FVM_DHF_033', '首次备案资料汇编', 'DHF', 33, 'IRD-项目代码-XXX', 'TRANSFER'),
('DCC_FVM_DHF_034', '变更备案资料汇编', 'DHF', 34, 'ARD-项目代码-XXX', 'TRANSFER'),
('DCC_FVM_DHF_035', '生产许可/备案资料汇编', 'DHF', 35, '', 'TRANSFER'),
('DCC_FVM_DMR_001', '产品技术要求', 'DMR', 1, 'DMR-项目代码-XXX', 'OUTPUT'),
('DCC_FVM_DMR_002', '生产用设备清单', 'DMR', 2, 'DMR-项目代码-XXX', 'OUTPUT'),
('DCC_FVM_DMR_003', '检验用设备清单', 'DMR', 3, 'DMR-项目代码-XXX', 'OUTPUT'),
('DCC_FVM_DMR_004', 'BOM表', 'DMR', 4, 'DMR-项目代码-XXX', 'OUTPUT'),
('DCC_FVM_DMR_005', '产品说明书', 'DMR', 5, 'DMR-项目代码-XXX', 'OUTPUT'),
('DCC_FVM_DMR_006', '成品图纸', 'DMR', 6, '/', 'OUTPUT'),
('DCC_FVM_DMR_007', '零配件图纸', 'DMR', 7, '', 'OUTPUT'),
('DCC_FVM_DMR_008', '包装设计', 'DMR', 8, '', 'OUTPUT'),
('DCC_FVM_DMR_009', '标签、合格证', 'DMR', 9, '', 'OUTPUT'),
('DCC_FVM_DMR_010', '物资采购清单', 'DMR', 10, 'P-项目代码', 'OUTPUT'),
('DCC_FVM_DMR_011', '采购技术要求', 'DMR', 11, 'P-项目代码-XXX', 'OUTPUT'),
('DCC_FVM_DMR_012', '工艺流程图', 'DMR', 12, 'PP-项目代码-X', 'OUTPUT'),
('DCC_FVM_DMR_013', '工序卡/作业指导书', 'DMR', 13, 'PP-项目代码-X-YY', 'OUTPUT'),
('DCC_FVM_DMR_014', '项目间通用工序卡/作业指导书', 'DMR', 14, 'PP-CR-XXX', 'OUTPUT'),
('DCC_FVM_DMR_015', '来料检验规程', 'DMR', 15, 'IQC-项目代码-XXX', 'OUTPUT'),
('DCC_FVM_DMR_016', '过程检验规程', 'DMR', 16, 'PQC-项目代码-XXX', 'OUTPUT'),
('DCC_FVM_DMR_017', '成品检验规程', 'DMR', 17, 'FQC-项目代码-XXX', 'OUTPUT'),
('DCC_FVM_DMR_018', '检验记录表单', 'DMR', 18, 'RE-来料/过程/成品sop-XX', 'OUTPUT'),
('DCC_FVM_DMR_019', '生产记录表单', 'DMR', 19, 'INT/RE/XXX-XX', 'OUTPUT'),
('DCC_FVM_DMR_020', '标准测试方法', 'DMR', 20, 'STM-XX-XXX', 'OUTPUT'),
('DCC_FVM_DMR_021', '设备采购技术要求', 'DMR', 21, 'P-EQ-设备编号', 'OUTPUT'),
('DCC_FVM_DMR_022', '生产/检验用工装模具采购技术要求及设计图纸', 'DMR', 22, 'P-项目代码-模具编号', 'OUTPUT'),
('DCC_FVM_DMR_023', '生产/检验用工装模具维护保养规范', 'DMR', 23, 'SOP-M-模具编号', 'OUTPUT'),
('DCC_FVM_DMR_024', '生产/检验用工装模具维护保养记录表', 'DMR', 24, 'RE-SOP-M-模具编号', 'OUTPUT');
...
('DCC_FVM_DMR_024', '电子文控系统推进计划及需求表.xlsx', 63, 'G', 'QMS', 'QMS', NULL, '●', 'ALL_MEMBERS');
  ...
  INSERT INTO dcc_file_category
    (code, name, parent_id, active, sort, source, remark, description,
     lifecycle_stage, distribution_required, training_required, tenant_id, create_time, update_time, creator, updater, deleted)
  SELECT seed.category_code, seed.file_name, NULL, 1, seed.matrix_sort, 'DCC_VIEW_MATRIX_SEED',
         ...
         seed.lifecycle_stage, 0, 0, @dcc_view_matrix_seed_tenant_id, NOW(), NOW(), @dcc_view_matrix_seed_actor, @dcc_view_matrix_seed_actor, 0
  FROM tmp_dcc_view_matrix_seed_category seed
  ...
  SET category.name = seed.file_name,
      ...
      category.lifecycle_stage = seed.lifecycle_stage,
