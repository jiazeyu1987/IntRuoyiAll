-- release-target-preflight: migrationId=20260830_mdm_company_scope_crud_menu; allowedEnvironments=test,backup,prod
SELECT CASE WHEN
...
THEN 'TARGET_PREFLIGHT_PASS:20260830_mdm_company_scope_crud_menu' ELSE 'TARGET_PREFLIGHT_BLOCKED:20260830_mdm_company_scope_crud_menu' END;
