-- release-target-preflight: migrationId=20260725_system_backup_plan_menu; allowedEnvironments=test,backup,prod
SELECT CASE WHEN
  ...
  AND (SELECT COUNT(*) FROM system_menu WHERE id = 1 AND deleted = b'0') = 1
...
THEN 'TARGET_PREFLIGHT_PASS:20260725_system_backup_plan_menu' ELSE 'TARGET_PREFLIGHT_BLOCKED:20260725_system_backup_plan_menu' END;
