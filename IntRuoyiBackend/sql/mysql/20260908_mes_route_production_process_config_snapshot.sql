-- type: schema
-- dependsOn: 20260903_mes_process_pool_device_selection_mode
-- riskLevel: medium
-- description: route version production process config projection and active order frozen snapshot envelope
