-- release-migration: allowedEnvironments=test,backup,prod; dependsOn=20260626_showroom_keyword_bu_seed; type=seed; riskLevel=low
-- Add glossary override for 翰凌 -> Healing so sub-term translation matches showroom keyword rules.
