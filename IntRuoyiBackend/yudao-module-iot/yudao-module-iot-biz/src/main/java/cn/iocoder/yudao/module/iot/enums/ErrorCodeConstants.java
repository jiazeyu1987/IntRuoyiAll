...
public interface ErrorCodeConstants {
    ...
    ErrorCode OTA_TASK_PAUSE_FAIL_STATUS_ERROR = new ErrorCode(1_050_008_105, "暂停 OTA 任务失败，原因：任务状态不是进行中");
    ErrorCode OTA_TASK_RESUME_FAIL_STATUS_ERROR = new ErrorCode(1_050_008_106, "继续 OTA 任务失败，原因：任务状态不是已暂停");
