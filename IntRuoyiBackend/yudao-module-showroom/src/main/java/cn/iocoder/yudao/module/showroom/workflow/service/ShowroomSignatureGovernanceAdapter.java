...
@Component
public class ShowroomSignatureGovernanceAdapter implements SignatureGovernanceAdapter {

    public static final String ADAPTER_CODE = "showroom-governance-adapter";
    public static final String ADAPTER_VERSION = "showroom-adapter-v1";
    public static final String EVIDENCE_SCHEMA_VERSION = "showroom-signature-v1";
    public static final String ACTION_CHANGE_REQUEST_APPROVE = "SHOWROOM_CHANGE_REQUEST_APPROVE";

    private static final String MEANING_CHANGE_REQUEST_APPROVE = "CHANGE_REQUEST_APPROVE";

    @Override
    public SignatureGovernanceModuleCode getModuleCode() {
        return SignatureGovernanceModuleCode.SHOWROOM;
    }
    ...
    public List<SignatureGovernanceActionDefinition> getActionDefinitions() {
        return List.of(SignatureGovernanceActionDefinition.of(ACTION_CHANGE_REQUEST_APPROVE,
                MEANING_CHANGE_REQUEST_APPROVE, ShowroomApprovalSignatureService.APPROVAL_STAGE_PUBLICITY,
    ...
    public SignatureGovernanceAdapterProjection execute(SignatureGovernancePolicyEvaluationCommand command,
        ...
        return SignatureGovernanceAdapterProjection.of(getModuleCode(), getAdapterCode(), getAdapterVersion(),
                ...
                definition.meaningCode(), "showroom-change-request:" + command.sourceRecordId(),
