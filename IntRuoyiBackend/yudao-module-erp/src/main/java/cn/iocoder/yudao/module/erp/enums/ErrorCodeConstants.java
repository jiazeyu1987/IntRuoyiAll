...
ErrorCode PURCHASE_ORDER_ITEM_RETURN_FAIL_IN_EXCEED = new ErrorCode(1_030_101_009, "采购订单项({})超过最大允许退货数量({})");
    ...
    ErrorCode KINGDEE_PURCHASE_ORDER_CONFIG_MISSING = new ErrorCode(1_030_101_011, "Kingdee K3Cloud采购订单同步配置缺失：{}");
    ErrorCode KINGDEE_PURCHASE_ORDER_CONFIG_INVALID = new ErrorCode(1_030_101_012, "Kingdee K3Cloud采购订单同步配置无效：{}");
    ErrorCode KINGDEE_PURCHASE_ORDER_REQUEST_FAIL = new ErrorCode(1_030_101_013, "Kingdee K3Cloud采购订单请求失败：{}");
    ErrorCode KINGDEE_PURCHASE_ORDER_RESPONSE_INVALID = new ErrorCode(1_030_101_014, "Kingdee K3Cloud采购订单响应无效：{}");
    ErrorCode KINGDEE_PURCHASE_ORDER_SUPPLIER_MAPPING_MISSING = new ErrorCode(1_030_101_015, "Kingdee供应商({})未配置IntRuoyi供应商映射");
    ErrorCode KINGDEE_PURCHASE_ORDER_PRODUCT_MAPPING_MISSING = new ErrorCode(1_030_101_016, "Kingdee物料({})未配置IntRuoyi产品映射");
    ErrorCode KINGDEE_PRODUCTION_ORDER_CONFIG_MISSING = new ErrorCode(1_030_101_017, "Kingdee K3Cloud生产订单配置缺失：{}");
    ErrorCode KINGDEE_PRODUCTION_ORDER_CONFIG_INVALID = new ErrorCode(1_030_101_018, "Kingdee K3Cloud生产订单配置无效：{}");
    ...
    ErrorCode KINGDEE_PRODUCTION_REPLENISHMENT_LIST_REQUEST_FAIL = new ErrorCode(1_030_101_025, "Kingdee K3Cloud生产补料单请求失败：{}");
    ErrorCode KINGDEE_PRODUCTION_REPLENISHMENT_LIST_RESPONSE_INVALID = new ErrorCode(1_030_101_026, "Kingdee K3Cloud生产补料单响应无效：{}");
    ...
    ErrorCode KINGDEE_TABLE_AUTO_SYNC_JOB_NOT_CONFIGURED = new ErrorCode(1_030_101_051, "ERP 表格自动同步调度任务未配置：{}");
    ...
    ErrorCode KINGDEE_EVENT_CALLBACK_SECRET_MISSING = new ErrorCode(1_030_901_000, "Kingdee事件回调密钥未配置：{}");
    ErrorCode KINGDEE_EVENT_CALLBACK_SIGNATURE_MISSING = new ErrorCode(1_030_901_001, "Kingdee事件回调签名参数缺失：{}");
    ErrorCode KINGDEE_EVENT_CALLBACK_SIGNATURE_INVALID = new ErrorCode(1_030_901_002, "Kingdee事件回调签名无效");
    ErrorCode KINGDEE_EVENT_CALLBACK_PAYLOAD_INVALID = new ErrorCode(1_030_901_003, "Kingdee事件回调载荷无效：{}");
    ErrorCode KINGDEE_EVENT_CALLBACK_FIELD_MISSING = new ErrorCode(1_030_901_004, "Kingdee事件回调字段缺失：{}");
