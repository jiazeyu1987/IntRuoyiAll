...
@TableName("erp_kingdee_production_pick_list_item")
@KeySequence("erp_kingdee_production_pick_list_item_seq")
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class ErpKingdeeProductionPickListItemDO extends TenantBaseDO {

    @TableId
    private Long id;
    private Long productionPickListId;
