...
@TableName("erp_kingdee_production_replenishment_list")
@KeySequence("erp_kingdee_production_replenishment_list_seq")
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class ErpKingdeeProductionReplenishmentListDO extends TenantBaseDO {
