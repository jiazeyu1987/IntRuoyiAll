...
public interface ProcessPoolTimelineService {

    PageResult<ProcessPoolTimelineEventRespVO> getTimelinePage(ProcessPoolTimelinePageReqVO reqVO);

    ProcessPoolTimelineDetailRespVO getTimelineDetail(Long eventId);
