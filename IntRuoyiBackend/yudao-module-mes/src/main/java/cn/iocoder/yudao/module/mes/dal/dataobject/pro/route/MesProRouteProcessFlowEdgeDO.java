 ...
 * MES 工艺路线工序流转关系边 DO
 */
@TableName("mes_pro_route_process_flow_edge")
@KeySequence("mes_pro_route_process_flow_edge_seq")
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class MesProRouteProcessFlowEdgeDO extends TenantBaseDO {
