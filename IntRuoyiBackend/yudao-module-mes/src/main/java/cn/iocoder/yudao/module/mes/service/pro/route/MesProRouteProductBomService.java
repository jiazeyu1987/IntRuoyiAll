...
public interface MesProRouteProductBomService {
     ...
     * 删除工艺路线产品 BOM
     */
    void deleteRouteProductBom(Long id, Long routeVersionId);
    ...
    /**
     * 按工序业务身份查询路线 BOM，兼容同编码的历史工序编号。
     */
    List<MesProRouteProductBomDO> getRouteProductBomListByProcessIdentity(
