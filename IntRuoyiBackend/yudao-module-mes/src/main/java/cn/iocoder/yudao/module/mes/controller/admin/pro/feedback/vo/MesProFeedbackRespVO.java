...
public class MesProFeedbackRespVO {
    ...
    @Schema(description = "Excel 产品代码", example = "YXN.069.001.1005")
    @ExcelProperty("产品代码")
    private String excelProductCode;

    @Schema(description = "Excel 产品名称", example = "冠状动脉棘突球囊扩张导管")
    @ExcelProperty("产品名称")
    private String excelProductName;

    @Schema(description = "Excel 工序编码", example = "Z2976")
    @ExcelProperty("工序编码")
    private String excelProcessCode;

    @Schema(description = "Excel 工序名称", example = "棘突丝切割")
    @ExcelProperty("工序名称")
    private String excelProcessName;

    @Schema(description = "Excel 部门", example = "组装")
    @ExcelProperty("部门")
    private String excelDepartment;

    @Schema(description = "Excel 人员工号", example = "A2020070")
    @ExcelProperty("人员工号")
    private String excelEmployeeNo;

    @Schema(description = "Excel 人员名称", example = "苗庆红")
    @ExcelProperty("人员名称")
    private String excelEmployeeName;

    @Schema(description = "Excel 工段长", example = "李萍")
    @ExcelProperty("工段长")
    private String excelSectionLeader;

    @Schema(description = "Excel 日期")
    @ExcelProperty("日期")
    private LocalDateTime excelFeedbackTime;
    ...
    @Schema(description = "排产工单编号", example = "1")
    private Long scheduleOrderId;

    @Schema(description = "排产工序快照编号", example = "1")
    ...
    @Schema(description = "当前审批人昵称", example = "李四")
    @ExcelProperty("当前审批人")
    ...
    @Schema(description = "来源导入记录编号", example = "1024")
    private Long sourceImportRecordId;

    @Schema(description = "来源导入文件名", example = "feedback.xlsx")
    private String sourceImportFileName;

    @Schema(description = "来源导入工作表", example = "Sheet1")
    private String sourceImportSheetName;

    @Schema(description = "来源导入行号", example = "12")
    private Integer sourceImportRowNo;

    @Schema(description = "来源导入归属时间")
    private LocalDateTime sourceImportAttributionTime;

    @Schema(description = "审批影响说明")
    private String approvalImpactText;
