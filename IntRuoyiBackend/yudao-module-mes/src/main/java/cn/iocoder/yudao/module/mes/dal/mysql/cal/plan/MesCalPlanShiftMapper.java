...
public interface MesCalPlanShiftMapper extends BaseMapperX<MesCalPlanShiftDO> {
    ...
    default int updateEndTimeById(Long id, String endTime) {
        return update(null, new LambdaUpdateWrapper<MesCalPlanShiftDO>()
                .eq(MesCalPlanShiftDO::getId, id)
                .set(MesCalPlanShiftDO::getEndTime, endTime));
    }
