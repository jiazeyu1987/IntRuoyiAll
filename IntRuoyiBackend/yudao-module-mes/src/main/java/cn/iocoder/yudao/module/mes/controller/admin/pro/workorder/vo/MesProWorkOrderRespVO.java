...
public class MesProWorkOrderRespVO {
    ...
    @Schema(description = "生产车间", example = "组装车间")
    @ExcelProperty("生产车间")
    private String workshopName;

    @Schema(description = "BOM版本", example = "BOM-2026-01")
    @ExcelProperty("BOM版本")
    private String bomVersion;

    @Schema(description = "冲领料", example = "直接领料")
    @ExcelProperty("冲领料")
    private String pickMode;

    @Schema(description = "备注1助记码", example = "K20260113")
    @ExcelProperty("备注1助记码")
    private String auxiliaryCode;

    @Schema(description = "业务状态", example = "424")
    @ExcelProperty("业务状态")
    ...
    @Schema(description = "关联生产用料清单数量", example = "2")
    private Long productionMaterialListCount;

    @Schema(description = "关联生产用料清单摘要", example = "PPBOM-001、PPBOM-002")
