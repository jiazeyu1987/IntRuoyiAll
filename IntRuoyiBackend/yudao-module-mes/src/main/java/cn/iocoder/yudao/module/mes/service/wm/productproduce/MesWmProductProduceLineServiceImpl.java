...
public class MesWmProductProduceLineServiceImpl implements MesWmProductProduceLineService {
    ...
    @Override
    public List<String> getDistinctBatchCodesByWorkOrderId(Long workOrderId) {
        return productProduceLineMapper.selectDistinctBatchCodesByWorkOrderId(workOrderId);
    }
