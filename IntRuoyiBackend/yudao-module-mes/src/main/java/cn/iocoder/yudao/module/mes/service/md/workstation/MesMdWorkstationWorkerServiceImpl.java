...
public class MesMdWorkstationWorkerServiceImpl implements MesMdWorkstationWorkerService {
    ...
    @Override
    public List<MesMdWorkstationWorkerDO> getWorkstationWorkerListByWorkstationIds(Collection<Long> workstationIds) {
        if (workstationIds == null || workstationIds.isEmpty()) {
            return Collections.emptyList();
        }
        return workstationWorkerMapper.selectListByWorkstationIds(workstationIds);
    }
