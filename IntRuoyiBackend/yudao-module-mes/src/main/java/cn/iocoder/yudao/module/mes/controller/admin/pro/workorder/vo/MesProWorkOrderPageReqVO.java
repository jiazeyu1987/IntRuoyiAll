...
public class MesProWorkOrderPageReqVO extends PageParam {
    ...
    @Schema(description = "产品名称候选产品编号", example = "100")
    private Long productNameFilterId;

    @Schema(description = "产品名称关键词", example = "球囊扩张压力泵")
    private String productNameKeyword;

    @Schema(description = "产品编码候选产品编号", example = "100")
    private Long productCodeFilterId;

    @Schema(description = "产品编码关键词", example = "YXN.037.011.1004")
    private String productCodeKeyword;
