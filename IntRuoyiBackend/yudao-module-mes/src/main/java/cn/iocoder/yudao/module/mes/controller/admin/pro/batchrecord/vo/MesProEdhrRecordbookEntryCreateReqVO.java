...
@Schema(description = "管理后台 - MES eDHR 记录本条目创建 Request VO")
@Data
public class MesProEdhrRecordbookEntryCreateReqVO {

    @Schema(description = "记录本 ID", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull(message = "记录本 ID 不能为空")
