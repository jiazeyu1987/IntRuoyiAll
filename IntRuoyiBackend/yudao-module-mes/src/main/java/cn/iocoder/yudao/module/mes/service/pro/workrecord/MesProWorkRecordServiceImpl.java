...
public class MesProWorkRecordServiceImpl implements MesProWorkRecordService {
    ...
    @Override
    public List<MesProWorkRecordDO> getClockInWorkRecordListByWorkstationIds(Collection<Long> workstationIds) {
        if (workstationIds == null || workstationIds.isEmpty()) {
            return Collections.emptyList();
        }
        return workRecordMapper.selectListByWorkstationIdsAndType(
                workstationIds, MesProWorkRecordTypeEnum.CLOCK_IN.getType());
    }
