...
public interface MesProFeedbackService {
     ...
     *
     * @param id 编号
     * @param allowImportedDraft 是否允许来源于导入记录的草稿走当前入口
     */
    void submitFeedback(Long id, boolean allowImportedDraft);
     ...
     * @param reason 驳回原因
     */
    void rejectFeedback(Long id, String reason);
