...
public interface MesProWorkOrderService {
     ...
     * 查询生产工单实际使用过的产品名称候选。
     *
     * @param keyword 产品名称关键字
     * @return 产品名称列表
     */
    List<String> getWorkOrderProductNameOptions(String keyword);
     ...
     * @param batchCode 批次号
     */
    void updateBatchCodeIfBlank(Long id, String batchCode);
     ...
     * @return 临时冻结状态
     */
    MesProWorkOrderTemporaryFreezeStatusRespVO getTemporaryFreezeStatus();
     ...
     * @return 更新后的临时冻结状态
     */
    MesProWorkOrderTemporaryFreezeStatusRespVO updateTemporaryFreeze(Boolean enabled);

    /**
     * 更新单个工单的临时冻结状态
     *
     * @param id 工单编号
     * @param temporaryFrozen 是否临时冻结
     */
    void updateWorkOrderTemporaryFrozen(Long id, Boolean temporaryFrozen);
