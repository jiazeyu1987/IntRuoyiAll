...
public interface MesProWorkOrderBomMapper extends BaseMapperX<MesProWorkOrderBomDO> {
    ...
    default List<MesProWorkOrderBomDO> selectListByWorkOrderIds(Collection<Long> workOrderIds) {
        if (workOrderIds == null || workOrderIds.isEmpty()) {
            return Collections.emptyList();
        }
        return selectList(new LambdaQueryWrapperX<MesProWorkOrderBomDO>()
                .in(MesProWorkOrderBomDO::getWorkOrderId, workOrderIds));
    }
