...
assert.match(service, /MesQaInspectionRegulationItemEquipmentMapper/)
assert.match(service, /itemEquipmentMapper\.deleteByVersionId/)
assert.match(service, /itemEquipmentMapper\.insert/)
assert.match(service, /MesDvMachineryService/)
assert.match(service, /getMachineryMap/)
assert.match(service, /equipmentRequired\(CollUtil\.isNotEmpty\(item\.getEquipmentOptions\(\)\)\)/)
assert.match(frontline, /MesQaInspectionRegulationItemEquipmentMapper/)
assert.doesNotMatch(frontline, /MesPqcItemEquipmentConfigService|pqcItemEquipmentConfigService/)
assert.match(frontline, /getEquipmentOptions\(\)/)
...
console.log('PASS: QA version equipment snapshot and frontline locked-version source contract')
