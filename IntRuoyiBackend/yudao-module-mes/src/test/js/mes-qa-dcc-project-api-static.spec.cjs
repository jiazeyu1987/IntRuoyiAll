...
assert.match(statusVo, /private String publishedVersionNo;/)
...
assert.doesNotMatch(service, /selectByRouteProcess|selectListByProductIds/)
...
assert.match(service, /setPublishedVersionNo\(productionReady \? published\.getVersionNo\(\) : null\)/)
