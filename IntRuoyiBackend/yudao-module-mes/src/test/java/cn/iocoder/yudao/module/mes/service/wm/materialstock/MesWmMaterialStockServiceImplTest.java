...
public class MesWmMaterialStockServiceImplTest extends BaseDbUnitTest {
    ...
    @Test
    public void testGetMaterialStockPage_virtualFilterOnly_withoutVirtualWarehouse() {
    ...
    @Test
    public void testGetMaterialStockPage_virtualFilterExclude_withoutVirtualWarehouse() {
        MesWmMaterialStockDO normalStock = createMaterialStockPojo(o -> o.setWarehouseId(200L));
        materialStockMapper.insert(normalStock);
        when(warehouseService.getWarehouseByCode(MesWmWarehouseDO.WIP_VIRTUAL_WAREHOUSE))
                .thenReturn(null);
