...
class MesTeamLeaderOrderProcessCompletionServiceTest {
    ...
    @Test
    void shouldCompleteOrderProcessWithoutFinalBackfillWhenCumulativeQuantityReachesTarget() {
        ...
        assertEquals("PROCESS_POOL_REPORT_BACKFILL_AGG:9001:5001:6001:" + saved.getAggregateHash(),
                saved.getBackfillIdempotencyKey());
    }
    ...
    @Test
    void shouldResetHistoricalBackfillStateToSourceFactsOnRepeatedProcessConfirmation() {
        MesProProcessPoolEventDO event = event();
    ...
    @Test
    void shouldRecordSourceFactsWhenLeaderCorrectionResolvesConfirmedOverageAtTarget() {
        MesProProcessPoolEventDO event = event();
    ...
    @Test
    void shouldResetLegacyBackfillStateToSourceFactsWhenCorrectionResolvesOverage() {
        MesProProcessPoolEventDO event = event();
        MesProcessPoolReportAllocationDO supersededOverage = allocation(9001L, "210", 7201L, 1001L, 7001L,
                LocalDateTime.of(2026, 8, 1, 9, 30));
        MesProcessPoolReportAllocationDO correctedLine = allocation(9001L, "200", 7301L, 1001L, 7002L,
