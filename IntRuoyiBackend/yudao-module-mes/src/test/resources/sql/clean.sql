...
DELETE FROM "mes_pro_edhr_release_decision";
...
DELETE FROM "mes_pro_edhr_batch_trace_outbox_event";
DELETE FROM "mes_pro_edhr_batch_execution_trace_manifest";
DELETE FROM "mes_pro_edhr_batch_execution_trace_link";
DELETE FROM "mes_pro_edhr_batch_execution_origin";
...
DELETE FROM "mes_qa_common_regulation_product_binding";
