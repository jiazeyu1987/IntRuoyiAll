...
CREATE TABLE IF NOT EXISTS "mes_frontline_device_account_route_binding" (
    "id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    "device_account_user_id" bigint NOT NULL,
    "route_id" bigint NOT NULL,
    "device_id" bigint NOT NULL,
    "workstation_id" bigint NOT NULL,
    "default_approve_user_id" bigint DEFAULT NULL,
    "recordbook_id" bigint DEFAULT NULL,
    ...
    "tenant_id" bigint NOT NULL DEFAULT 0,
    PRIMARY KEY ("id"),
    CONSTRAINT "uk_mes_frontline_route_binding"
        UNIQUE ("tenant_id", "device_account_user_id", "route_id", "device_id", "workstation_id", "deleted")
);
...
CREATE TABLE IF NOT EXISTS "mes_frontline_employee_template_binding" (
    ...
    "tenant_id" bigint NOT NULL DEFAULT 0,
    PRIMARY KEY ("id"),
    CONSTRAINT "uk_mes_frontline_template_binding"
        UNIQUE ("tenant_id", "actual_employee_id", "route_process_id", "process_id", "deleted")
);
...
CREATE TABLE IF NOT EXISTS "mes_pro_process_pool_review_copy_rule" (
    ...
    "value_type" varchar(32) DEFAULT NULL,
    "affects_allocation" bit NOT NULL DEFAULT FALSE,
    "allocation_field" varchar(64) DEFAULT NULL,
    "source_quantity_type" varchar(64) DEFAULT NULL,
    "template_field_metadata_json" clob NOT NULL,
    "enabled" bit NOT NULL DEFAULT TRUE,
    "remark" varchar(500) DEFAULT NULL,
    "creator" varchar(64) DEFAULT '',
...
CREATE INDEX IF NOT EXISTS "idx_mes_pp_review_copy_rule_context"
    ON "mes_pro_process_pool_review_copy_rule" ("tenant_id", "process_id", "device_id", "template_type", "enabled");
