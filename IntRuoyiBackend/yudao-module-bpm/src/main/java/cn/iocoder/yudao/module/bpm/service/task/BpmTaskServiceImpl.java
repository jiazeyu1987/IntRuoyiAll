...
public class BpmTaskServiceImpl implements BpmTaskService {
    ...
    public PageResult<Task> getTaskTodoPage(Long userId, BpmTaskPageReqVO pageVO) {
        ...
        if (userId != null) {
            taskQuery.taskCandidateOrAssigned(String.valueOf(userId)); // 分配给自己，或自己是候选人
        }
    ...
    public PageResult<HistoricTaskInstance> getTaskDonePage(Long userId, BpmTaskPageReqVO pageVO) {
        ...
        if (userId != null) {
            taskQuery.taskAssignee(String.valueOf(userId)); // 分配给自己
        }
        if (StrUtil.isNotBlank(pageVO.getName())) {
            taskQuery.taskNameLike("%" + pageVO.getName() + "%");
        }
...
//        }
    ...
    public void approveTask(Long userId, @Valid BpmTaskApproveReqVO reqVO) {
        ...
        if (userId != null) {
            processVariables.put(BpmnVariableConstants.PROCESS_INSTANCE_VARIABLE_LAST_APPROVER_USER_ID, userId);
        }
    ...
    public void rejectTask(Long userId, @Valid BpmTaskRejectReqVO reqVO) {
        ...
        if (userId != null) {
            runtimeService.setVariable(task.getProcessInstanceId(),
                    BpmnVariableConstants.PROCESS_INSTANCE_VARIABLE_LAST_APPROVER_USER_ID, userId);
        }
