...
import cn.iocoder.yudao.module.bpm.service.task.BpmTaskExternalSignatureGuard;
...
public class BpmTaskController {
    ...
    @Resource
    private BpmTaskExternalSignatureGuard taskExternalSignatureGuard;
    @Resource
    ...
    public CommonResult<Boolean> approveTask(@Valid @RequestBody BpmTaskApproveReqVO reqVO) {
        taskExternalSignatureGuard.assertGenericApproveOrRejectAllowed(taskService.getTask(reqVO.getId()));
    ...
    public CommonResult<Boolean> returnTask(@Valid @RequestBody BpmTaskReturnReqVO reqVO) {
        taskExternalSignatureGuard.assertGenericTaskMutationAllowed(taskService.getTask(reqVO.getId()));
    ...
    public CommonResult<Boolean> withdrawTask(@RequestParam("taskId") String taskId) {
        taskExternalSignatureGuard.assertGenericTaskMutationAllowed(taskService.getTask(taskId));
