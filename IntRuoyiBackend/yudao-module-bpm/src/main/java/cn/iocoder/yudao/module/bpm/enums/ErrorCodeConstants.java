...
public interface ErrorCodeConstants {
    ...
    ErrorCode PROCESS_INSTANCE_ACCESS_DENIED = new ErrorCode(1_009_004_009, "流程实例访问失败，只有发起人、处理人或 BPM 管理员可查看该流程");
    ...
    ErrorCode APPROVAL_SIGNATURE_IMAGE_REQUIRED = new ErrorCode(1_009_006_001,
            "审批电子签名图片缺失或未启用，请先上传并启用电子签名图片");
    ErrorCode APPROVAL_VIEW_TYPE_UNSUPPORTED = new ErrorCode(1_009_006_002,
            "审批模块【{}】不支持视图【{}】");
