...
import cn.iocoder.yudao.module.bpm.formcenter.runtime.FormCenterBpmEventBridge;
...
public class BpmTaskEventListener extends AbstractFlowableEngineEventListener {
    ...
    @Resource
    @Lazy
    private FormCenterBpmEventBridge formCenterBpmEventBridge;
    ...
    protected void taskCreated(FlowableEngineEntityEvent event) {
        ...
        FlowableUtils.execute(entity.getTenantId(), () -> {
            ...
            formCenterBpmEventBridge.onTaskCreated(entity);
        });
    }
    ...
    protected void taskAssigned(FlowableEngineEntityEvent event) {
        ...
        FlowableUtils.execute(entity.getTenantId(), () -> {
            ...
            formCenterBpmEventBridge.onTaskAssigned(entity);
        });
    }
    ...
    protected void taskCompleted(FlowableEngineEntityEvent event) {
        ...
        FlowableUtils.execute(entity.getTenantId(), () -> {
            ...
            formCenterBpmEventBridge.onTaskCompleted(entity);
        });
    }
