...
DELETE FROM `dcc_publication_notification_audit`;
DELETE FROM `dcc_publication_notification_delivery`;
...
DELETE FROM `dcc_publication_notification_candidate`;
DELETE FROM `dcc_publication_visibility_user_snapshot`;
DELETE FROM `dcc_publication_visibility_rule_snapshot`;
DELETE FROM `dcc_publication_followup_batch`;
