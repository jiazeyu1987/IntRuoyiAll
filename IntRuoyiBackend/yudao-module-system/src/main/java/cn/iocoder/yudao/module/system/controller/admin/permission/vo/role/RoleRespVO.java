...
public class RoleRespVO {
    ...
    @Schema(description = "角色分类编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
    private Long categoryId;

    @Schema(description = "角色分类名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "展厅")
    @ExcelProperty("角色分类")
    private String categoryName;

    @Schema(description = "角色分类标识", requiredMode = Schema.RequiredMode.REQUIRED, example = "showroom")
    private String categoryCode;

    @Schema(description = "已分配用户数", requiredMode = Schema.RequiredMode.REQUIRED, example = "12")
    @ExcelProperty("分配人数")
