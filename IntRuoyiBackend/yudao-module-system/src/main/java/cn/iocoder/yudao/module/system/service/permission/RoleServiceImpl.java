...
public class RoleServiceImpl implements RoleService {
    ...
    public Long createRole(RoleSaveReqVO createReqVO, Integer type) {
        ...
        roleCategoryService.validateRoleCategoryEnabled(createReqVO.getCategoryId());
    ...
    public void updateRole(RoleSaveReqVO updateReqVO) {
        ...
        roleCategoryService.validateRoleCategoryEnabled(updateReqVO.getCategoryId());
    ...
    public Map<Long, RoleCategoryDO> getRoleCategoryMap(Collection<Long> ids) {
        return roleCategoryService.getRoleCategoryMap(ids);
    }

    @Override
    public Map<Long, Long> getAssignedUserCountMap(Collection<Long> roleIds) {
        if (CollectionUtil.isEmpty(roleIds)) {
            return Collections.emptyMap();
        }
        Map<Long, Long> countMap = userRoleMapper.selectCountMapByRoleIds(roleIds);
        roleIds.forEach(roleId -> countMap.putIfAbsent(roleId, 0L));
        return countMap;
    }
