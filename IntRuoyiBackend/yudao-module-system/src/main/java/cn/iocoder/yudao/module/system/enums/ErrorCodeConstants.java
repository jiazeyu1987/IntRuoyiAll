...
public interface ErrorCodeConstants {
    ...
    ErrorCode ROLE_CATEGORY_NOT_EXISTS = new ErrorCode(1_002_002_006, "角色分类不存在");
    ErrorCode ROLE_CATEGORY_NAME_DUPLICATE = new ErrorCode(1_002_002_007, "已经存在名为【{}】的角色分类");
    ErrorCode ROLE_CATEGORY_CODE_DUPLICATE = new ErrorCode(1_002_002_008, "已经存在标识为【{}】的角色分类");
    ErrorCode ROLE_CATEGORY_DISABLE = new ErrorCode(1_002_002_009, "角色分类【{}】已被禁用");
    ErrorCode ROLE_CATEGORY_HAS_ROLES = new ErrorCode(1_002_002_010, "角色分类【{}】下仍存在权限角色，无法删除");

    // ========== 配置包 1-002-030-000 ==========
    ErrorCode CONFIG_PACKAGE_FILE_EMPTY = new ErrorCode(1_002_030_000, "配置包文件不能为空");
    ErrorCode CONFIG_PACKAGE_SHEET_MISSING = new ErrorCode(1_002_030_001, "配置包缺少 Sheet【{}】");
    ErrorCode CONFIG_PACKAGE_MANIFEST_INVALID = new ErrorCode(1_002_030_002, "配置包 manifest 非法，原因：{}");
    ErrorCode CONFIG_PACKAGE_COMPONENT_MISSING = new ErrorCode(1_002_030_003, "菜单【{}】的组件路径【{}】在当前前端构建中不存在");
    ErrorCode CONFIG_PACKAGE_REFERENCE_MISSING = new ErrorCode(1_002_030_004, "配置包引用缺失，原因：{}");
    ErrorCode CONFIG_PACKAGE_PASSWORD_POLICY_MISMATCH = new ErrorCode(1_002_030_005, "配置包用户密码策略与目标环境不一致，原因：{}");
    ErrorCode CONFIG_PACKAGE_SNAPSHOT_MISMATCH = new ErrorCode(1_002_030_006, "目标环境已变化，请重新预检后再导入");
    ErrorCode CONFIG_PACKAGE_CONFIRM_REQUIRED = new ErrorCode(1_002_030_007, "请确认覆盖后再执行导入");
    ...
    ErrorCode USER_DING_TALK_IMPORT_LIST_IS_EMPTY = new ErrorCode(1_002_003_012, "钉钉导入用户数据不能为空！");
    ErrorCode USER_DING_TALK_IMPORT_HEADERS_MISSING = new ErrorCode(1_002_003_013, "钉钉导入 Excel 缺少必填表头");
    ErrorCode USER_DING_TALK_IMPORT_LEVEL_GAP = new ErrorCode(1_002_003_014, "钉钉导入 Excel 部门层级存在断层");
    ErrorCode USER_DING_TALK_IMPORT_COMPANY_REQUIRED = new ErrorCode(1_002_003_015, "钉钉导入 Excel 公司不能为空");
    ErrorCode USER_DING_TALK_IMPORT_NAME_REQUIRED = new ErrorCode(1_002_003_016, "钉钉导入 Excel 姓名不能为空");
    ErrorCode USER_DING_TALK_IMPORT_SOURCE_DEPT_ID_REQUIRED = new ErrorCode(1_002_003_017, "钉钉导入 Excel 主部门ID不能为空");
    ...
    ErrorCode DEPT_EXITS_USERS = new ErrorCode(1_002_004_008, "当前公司或部门下仍存在员工，请先删除员工后再删除组织");
