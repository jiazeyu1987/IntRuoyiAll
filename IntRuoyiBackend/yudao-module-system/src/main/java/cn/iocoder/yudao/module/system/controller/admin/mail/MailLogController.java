...
public class MailLogController {
    ...
    public void exportMailLog(@Valid MailLogPageReqVO exportReqVO,
                              HttpServletResponse response) throws IOException {
        exportReqVO.setPageSize(PageParam.PAGE_SIZE_NONE);
        List<MailLogDO> list = mailLogService.getMailLogPage(exportReqVO).getList();
        ExcelUtils.write(response, "邮件日志.xls", "数据", MailLogRespVO.class,
                BeanUtils.toBean(list, MailLogRespVO.class));
    }
