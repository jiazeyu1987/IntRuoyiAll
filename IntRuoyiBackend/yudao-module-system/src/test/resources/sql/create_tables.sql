...
CREATE TABLE IF NOT EXISTS "system_temporary_role_grant_audit" (
    ...
    "user_id" bigint NOT NULL,
    "role_id" bigint NOT NULL,
    "permission_code" varchar(150) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS "system_users" (
    ...
    "canonical_username" varchar(64) not null,
    "password" varchar(100) not null default '',
    "password_update_time" timestamp default null,
    "password_credential_status" varchar(32) not null default 'ACTIVE',
    ...
    "login_failure_window_start_time" timestamp default null,
...
CREATE TABLE IF NOT EXISTS "gxp_audit_event" (
    ...
    "server_occurred_at" timestamp NOT NULL,
    "before_state" varchar(32) NOT NULL,
    "before_object_version" varchar(128),
    "before_state_json" clob,
    "after_state" varchar(32) NOT NULL,
    "after_object_version" varchar(128),
    "after_state_json" clob,
    "policy_version" varchar(128) NOT NULL,
    "idempotency_key" varchar(128) NOT NULL,
    "request_id" varchar(128),
    "signature_record_id" varchar(128),
    "signature_content_hash" varchar(128),
    "idempotency_payload_hash" varchar(64) NOT NULL,
    "canonical_event_json" clob NOT NULL,
...
) COMMENT 'GxP 统一审计事件只追加账本';

CREATE TABLE IF NOT EXISTS "gxp_audit_ledger_sequence" (
    "tenant_id" bigint NOT NULL,
    "next_ledger_sequence" bigint NOT NULL,
    "create_time" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "update_time" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY ("tenant_id")
) COMMENT 'GxP 审计账本序号水位';
...
CREATE TABLE IF NOT EXISTS "gxp_audit_policy_version" (
    ...
    "approval_reference" varchar(256) NOT NULL,
    "coverage_report_hash" varchar(64) NOT NULL,
    "creator" varchar(64) DEFAULT '',
    "create_time" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updater" varchar(64) DEFAULT '',
    "update_time" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS "gxp_audit_policy_operation" (
    ...
    "reason_policy" varchar(64) NOT NULL,
    "signature_policy" varchar(64) NOT NULL,
    "state_policy" varchar(64) NOT NULL,
    "retention_class" varchar(64) NOT NULL,
    "test_ids" varchar(512) NOT NULL,
    ...
    "deleted" bit NOT NULL DEFAULT FALSE,
    PRIMARY KEY ("id"),
    UNIQUE ("tenant_id", "operation_id", "policy_version")
) COMMENT 'GxP 审计策略操作登记';
...
CREATE TABLE IF NOT EXISTS "gxp_audit_coverage_report" (
    ...
    "deleted" bit NOT NULL DEFAULT FALSE,
    PRIMARY KEY ("id"),
    UNIQUE ("tenant_id", "policy_version", "source_commit")
) COMMENT 'GxP 审计覆盖登记报告';
...
CREATE TABLE IF NOT EXISTS "gxp_audit_daily_manifest" (
    ...
    "sealed_at_utc" timestamp NOT NULL,
    "creator" varchar(64) DEFAULT '',
    "create_time" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updater" varchar(64) DEFAULT '',
    "update_time" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS "gxp_audit_seal_watermark" (
    ...
    "last_manifest_hash" varchar(64) NOT NULL,
    "unsealed_event_count" int NOT NULL,
    ...
    "deleted" bit NOT NULL DEFAULT FALSE,
    PRIMARY KEY ("id"),
    UNIQUE ("tenant_id", "watermark_hash")
) COMMENT 'GxP 审计封存水位';
