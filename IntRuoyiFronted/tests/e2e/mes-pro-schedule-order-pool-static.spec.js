...
assert(pageSource.includes('调整排产工单'), 'Schedule order page must expose the adjust dialog.')
assert(pageSource.includes('调整'), 'Schedule order list must expose adjust action.')
assert(pageSource.includes('openPriorityDialog'), 'Schedule order page must open the adjust dialog.')
assert(pageSource.includes('submitPriorityAdjust'), 'Schedule order page must submit adjust updates.')
assert(pageSource.includes('plannedStartTime: priorityForm.plannedStartTime'), 'Adjust action must submit planned start time.')
