...
assertIncludes(dialog, '@click="handleSourceCellClick(cell, $event)"', '预览单元格点击必须通过统一入口按当前模式分流。')
assertIncludes(dialog, '@click.stop="handleSourceCellClick(cell, $event)"', '预览单元格内部按钮点击不得向 td 冒泡导致重复切换。')
...
assertIncludes(dialog, ':model-value="isSelectedPropertyRequired"', '右侧面板必须可编辑必填状态。')
assertIncludes(dialog, '@change="handleSelectedRequiredChange"', '必填状态必须通过多选感知入口修改。')
assertIncludes(dialog, ':model-value="selectedPropertyValueType"', '右侧面板必须可编辑字段类型。')
assertIncludes(dialog, '@change="handleSelectedValueTypeChange"', '字段类型必须通过多选感知入口修改。')
assertIncludes(dialog, 'v-model="selectedRule.label"', '右侧面板必须可编辑字段名称。')
assertIncludes(dialog, ':model-value="selectedPropertyComponentFlag"', '右侧面板必须可编辑控件类型。')
assertIncludes(dialog, '@change="handleSelectedComponentFlagChange"', '控件类型必须通过多选感知入口修改。')
