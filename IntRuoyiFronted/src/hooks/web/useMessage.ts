...
type MessageBoxPromptOptions = NonNullable<Parameters<typeof ElMessageBox.prompt>[2]>
const APP_CONFIRM_MESSAGE_BOX_MODAL_CLASS = 'app-confirm-message-box-overlay'
  ...
  return {
    ...
    confirm(content: string, tip?: string) {
      return ElMessageBox.confirm(content, tip ? tip : t('common.confirmTitle'), {
        ...
        type: 'warning',
        modalClass: APP_CONFIRM_MESSAGE_BOX_MODAL_CLASS
      })
    },
    // 删除窗体
    ...
    // 提交内容
    prompt(content: string, tip: string, options: MessageBoxPromptOptions = {}) {
