...
const DEFAULT_APP_THEME: Required<ThemeTypes> = {
...
const buildDefaultAppTheme = (): ThemeTypes => ({ ...DEFAULT_APP_THEME })

const resetPersistedVisualPreferences = () => {
...
export const useAppStore = defineStore('app', {
  state: (): AppState => {
    resetPersistedVisualPreferences()
    return {
      ...
      isDark: false, // 全局固定为浅色模式
      currentSize: wsCache.get('default') || 'default', // 组件尺寸
      theme: buildDefaultAppTheme()
    }
  },
  getters: {
