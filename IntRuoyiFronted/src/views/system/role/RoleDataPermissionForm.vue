<template>
  <Dialog v-model="dialogVisible" title="权限角色数据权限" width="800">
...
interface RoleDataPermissionFormData {
  id?: number
  name: string
  code: string
  dataScope?: number
...
const formData = reactive<RoleDataPermissionFormData>(createDefaultFormData())
