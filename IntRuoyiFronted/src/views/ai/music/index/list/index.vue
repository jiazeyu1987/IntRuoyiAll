...
// 当前音乐
const currentSong = ref<Partial<MusicDisplayVO>>({})

const mySongList = ref<MusicDisplayVO[]>([])
const squareSongList = ref<MusicDisplayVO[]>([])
...
*/
function setCurrentSong (music: MusicDisplayVO) {
