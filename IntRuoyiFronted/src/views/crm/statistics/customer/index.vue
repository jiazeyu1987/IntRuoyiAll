  ...
  <el-col>
    <el-tabs v-model="activeTab">
      ...
      <el-tab-pane label="客户总量分析" lazy name="customerSummary">
        <CustomerSummary v-if="queryParams.deptId" ref="customerSummaryRef" :query-params="queryParams" />
        <el-empty v-else description="请选择归属部门后查询" />
      </el-tab-pane>
      <!-- 客户跟进次数分析 -->
      <el-tab-pane label="客户跟进次数分析" lazy name="followUpSummary">
        <CustomerFollowUpSummary
          v-if="queryParams.deptId"
          ref="followUpSummaryRef"
      ...
      <el-tab-pane label="客户跟进方式分析" lazy name="followUpType">
        <CustomerFollowUpType v-if="queryParams.deptId" ref="followUpTypeRef" :query-params="queryParams" />
        <el-empty v-else description="请选择归属部门后查询" />
      </el-tab-pane>
      <!-- 客户转化率分析 -->
