...
type BusinessStatusFormData = {
  id?: number
  name: string
  deptIds: number[]
  statuses: BusinessStatusFormItem[]
}

const createFormData = (): BusinessStatusFormData => ({
  id: undefined,
  name: '',
  deptIds: [],
  statuses: []
...
const formData = ref<BusinessStatusFormData>(createFormData())
