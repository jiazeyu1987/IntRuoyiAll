    ...
    <el-form class="-mb-15px" ref="queryForm" :inline="true" label-width="68px">
      ...
      <el-form-item label="时间范围" prop="dateRange">
        <el-date-picker
          ...
          :default-time="defaultDateRangeTime"
          @change="getSummary"
          class="!w-240px"
        />
      </el-form-item>
    ...
    <el-row>
      <el-col :span="12" class="card-box">
        <el-card>
          ...
          <Echart :options="userSummaryChartOption" :height="420" />
        </el-card>
      </el-col>
      <el-col :span="12" class="card-box">
        <el-card>
      ...
      <el-col :span="12" class="card-box">
        <el-card>
          ...
          <Echart :options="interfaceSummaryChartOption" :height="420" />
        </el-card>
      </el-col>
    </el-row>
  </ContentWrap>
...
const defaultDateRangeTime: [Date, Date] = [
...
/** 侦听公众号变化 **/
const userSummaryChartOption = computed(() => userSummaryOption as EChartsOption)
const interfaceSummaryChartOption = computed(() => interfaceSummaryOption as EChartsOption)
