<template>
  ...
  <BarcodeTemplateSelectDialog ref="templateDialogRef" @selected="handleTemplateSelected" />
</template>
...
import BarcodeTemplateSelectDialog from './components/BarcodeTemplateSelectDialog.vue'
...
const templateDialogRef = ref<InstanceType<typeof BarcodeTemplateSelectDialog>>()
...
const handleSelectTemplate = () => {
  templateDialogRef.value?.open(formData.value.defaultTemplate)
}

const handleTemplateSelected = (value: string) => {
  formData.value.defaultTemplate = value
}
