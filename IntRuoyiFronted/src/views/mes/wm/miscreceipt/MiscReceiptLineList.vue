...
type MiscReceiptLineFormData = Partial<WmMiscReceiptLineVO>

const formData = ref<MiscReceiptLineFormData>({
...
const formRules = reactive<FormRules<MiscReceiptLineFormData>>({
