...
type ArrivalNoticeLineFormData = Partial<WmArrivalNoticeLineVO>

const formData = ref<ArrivalNoticeLineFormData>({
  id: undefined,
  noticeId: undefined as number | undefined,
  itemId: undefined,
...
const formRules = reactive<FormRules<ArrivalNoticeLineFormData>>({
