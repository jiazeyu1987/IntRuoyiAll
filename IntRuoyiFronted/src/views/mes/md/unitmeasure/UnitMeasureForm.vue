...
type UnitMeasureFormData = Partial<MdUnitMeasureVO> & {
  primaryFlag: boolean
  status: number
}

const createDefaultFormData = (): UnitMeasureFormData => ({
  id: undefined,
  code: undefined,
  name: undefined,
  primaryFlag: true,
...
const formData = ref<UnitMeasureFormData>(createDefaultFormData())
