  ...
  <Dialog :title="dialogTitle" v-model="dialogVisible" width="960px">
    ...
    >
      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="单人小时产能" prop="singleStandardHourlyCapacity">
            <el-input-number
              v-model="formData.singleStandardHourlyCapacity"
              :min="0"
              :precision="2"
        ...
        <el-col :span="8">
          <el-form-item label="班次小时" prop="shiftHours">
            <el-input-number
...
const formData = ref({
  ...
  areaId: undefined,
  singleStandardHourlyCapacity: undefined,
