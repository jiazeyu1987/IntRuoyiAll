...
<template>
  <el-card shadow="hover" class="h-full">
    ...
    <el-row :gutter="12">
      <el-col v-for="item in shortcuts" :key="item.name" :xl="3" :lg="4" :md="6" :sm="8" :xs="12" class="mb-12px">
        <div
...
const shortcuts = [
  {
    name: '排产员工作台',
    icon: 'ep:monitor',
    routeName: 'MesProSchedulerWorkbench',
    bgColor: '#0f766e'
  },
  { name: '生产工单', icon: 'ep:document', routeName: 'MesProWorkOrder', bgColor: '#409EFF' },
  {
    name: '排产工单',
    icon: 'ep:operation',
    routeName: 'MesProScheduleOrder',
    bgColor: '#1677ff'
  },
  { name: '报工', icon: 'ep:edit', routeName: 'MesProFeedback', bgColor: '#67C23A' },
