...
type CombinationShowcaseItem = CombinationActivityApi.CombinationActivityVO & {
  picUrl?: string
}
...
// 拼团活动列表
const Activitys = ref<CombinationShowcaseItem[]>([])
...
const handleActivitySelected = (
  activityVOs: CombinationShowcaseItem | CombinationShowcaseItem[]
) => {
