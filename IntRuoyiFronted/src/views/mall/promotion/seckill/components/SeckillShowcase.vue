...
type SeckillShowcaseItem = SeckillActivityApi.SeckillActivityVO & {
  picUrl?: string
}
...
// 拼团活动列表
const Activitys = ref<SeckillShowcaseItem[]>([])
 ...
 */
const handleActivitySelected = (activityVOs: SeckillShowcaseItem | SeckillShowcaseItem[]) => {
