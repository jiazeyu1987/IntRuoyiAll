<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      ...
      />
      <el-table-column
        :formatter="totalCountFormatText"
        align="center"
        label="发放数量"
        prop="totalCount"
      />
      <el-table-column
        :formatter="remainedCountFormatText"
        align="center"
        label="剩余数量"
        prop="totalCount"
      />
      <el-table-column
        :formatter="takeLimitCountFormatText"
        align="center"
        label="领取上限"
        prop="takeLimitCount"
      />
...
/** 查询列表 */
const remainedCountFormatText = (row: CouponTemplateApi.CouponTemplateVO) =>
  String(remainedCountFormat(row))
const takeLimitCountFormatText = (row: CouponTemplateApi.CouponTemplateVO) =>
  String(takeLimitCountFormat(row))
const totalCountFormatText = (row: CouponTemplateApi.CouponTemplateVO) =>
  String(totalCountFormat(row))
