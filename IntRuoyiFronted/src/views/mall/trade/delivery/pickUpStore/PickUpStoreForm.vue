...
const formData = ref<Partial<DeliveryPickUpStoreApi.DeliveryPickUpStoreVO>>({
  id: undefined,
  name: '',
  phone: '',
  logo: '',
...
const initTencentLbsMap = async () => {
  ;(window as unknown as Window & { selectAddress: typeof selectAddress }).selectAddress =
    selectAddress
  window.addEventListener(
    ...
    function (event) {
      ...
      if (loc && loc.module === 'locationPicker') {
        ...
        ;(window.parent as unknown as Window & { selectAddress: (loc: any) => void }).selectAddress(
          loc
        )
      }
    },
