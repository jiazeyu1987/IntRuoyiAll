...
const handleQuery = (skipEmptyReset = false) => {
  if (skipEmptyReset !== true && isSearchFormInputEmpty(queryFormRef, queryParams.value)) {
    resetQuery()
    return
  }
  getList()
...
onMounted(async () => {
  ...
  if (route.query.categoryId) {
    queryParams.value.categoryId = Array.isArray(route.query.categoryId)
      ? route.query.categoryId.filter((categoryId): categoryId is string => categoryId !== null)
