...
<template>
  <el-form ref="formRef" :disabled="isDetail" :model="formData" :rules="rules" label-width="120px">
    ...
    <el-form-item label="商品轮播图" prop="sliderPicUrls">
      <UploadImgs v-model="sliderPicUrlsModel" :disabled="isDetail" />
    </el-form-item>
  </el-form>
</template>
...
const sliderPicUrlsModel = computed<string[] | string>({
  get: () => formData.sliderPicUrls ?? [],
  set: (value) => {
    formData.sliderPicUrls = Array.isArray(value) ? value : [value]
  }
})
