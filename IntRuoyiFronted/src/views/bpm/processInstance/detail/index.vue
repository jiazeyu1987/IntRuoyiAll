...
import { resolveProcessInstanceDisplayName, resolveProcessNodeDisplayName } from './display-name'
...
const currentApprovalStepLabel = computed(() => {
  ...
  if (currentNode) {
    return resolveProcessNodeDisplayName(currentNode.id, currentNode.name)
  }
