...
type Demo02CategoryTree = Demo02CategoryApi.Demo02CategoryVO & {
  children?: Demo02CategoryTree[]
}

interface Demo02CategoryQueryParams extends PageParam {
  name: string | null
...
const list = ref<Demo02CategoryTree[]>([]) // 列表的数据
...
const getList = async () => {
  ...
  try {
    ...
    list.value = handleTree(data, 'id', 'parentId') as Demo02CategoryTree[]
