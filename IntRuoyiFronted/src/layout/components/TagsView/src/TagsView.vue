...
const APPROVAL_TODO_BADGE_TAG_PATH = '/approval-center/todo'
const PERSONAL_WORKBENCH_TODO_BADGE_TAG_PATH = '/user/profile'
...
const isApprovalTodoBadgeTagsViewItem = (item: RouteLocationNormalizedLoaded) =>
  item.path === APPROVAL_TODO_BADGE_TAG_PATH

const shouldShowApprovalTodoBadge = (item: RouteLocationNormalizedLoaded) =>
  Boolean(
...
const isProfileWorkbenchTodoBadgeTagsViewItem = (item: RouteLocationNormalizedLoaded) =>
  item.path === PERSONAL_WORKBENCH_TODO_BADGE_TAG_PATH

const shouldShowProfileWorkbenchTodoBadge = (item: RouteLocationNormalizedLoaded) =>
  Boolean(
            ...
            <div>
              <router-link :ref="tagLinksRefs.set" v-slot="{ navigate }" :to="{ ...item }" custom>
                ...
                >
                  ...
                  <span
                    v-if="shouldShowApprovalTodoBadge(item)"
                  ...
                  <span
                    v-if="shouldShowProfileWorkbenchTodoBadge(item)"
