...
export interface MdProductBomErpSyncRespVO {
  itemId: number
...
export const MdProductBomApi = {
  ...
  // 鍚屾鍗曚釜鐗╂枡/浜у搧鐨?ERP BOM
  syncErpBom: async (itemId: number): Promise<MdProductBomErpSyncRespVO> => {
    return await request.post({ url: `/mes/md/product-bom/${itemId}/sync-erp-bom` })
  }
}
