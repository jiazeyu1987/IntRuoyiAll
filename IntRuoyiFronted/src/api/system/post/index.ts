...
export const exportPostConfigPackage = async () => {
  return await request.download({ url: '/system/post/config-package/export' })
}

export const importPostConfigPackage = async (data: FormData) => {
  return await request.upload({ url: '/system/post/config-package/import', data })
}
