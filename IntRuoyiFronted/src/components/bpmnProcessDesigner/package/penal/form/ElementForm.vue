...
const formKey = ref<any>(undefined)
...
// 打开字段详情侧边栏
const openFieldForm = (field: any, index: number) => {
...
// 打开字段 某个 配置项 弹窗
const openFieldOptionForm = (option: any, index: number, type: string) => {
...
// 移除某个 字段的 配置项
const removeFieldOptionItem = (_option: any, index: number, type: string) => {
...
// 移除 字段
const removeField = (_field: any, index: number) => {
...
onMounted(async () => {
  ...
  formKey.value = formKey.value ? parseInt(String(formKey.value)) : undefined
})
