...
- RED: 真实前端路径失败，locator.waitFor: Timeout 30000ms exceeded.
Call log:
[2m  - waiting for locator('.el-dialog:visible').first().locator('input[placeholder="请先选择工单，再选择该产品绑定的工艺路线"]').first() to be visible[22m
