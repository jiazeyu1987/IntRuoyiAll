...
- RED: `pnpm e2e:edhr:approval-tracking` -> FAIL, DRAFT 禁止归档负向证明 工序 task/open API 响应 code 应为 0，实际 1040750434，msg=eDHR 对象级权限不足：BATCH_EXECUTION_TASK:2737:FILL
