...
- 追踪页目标执行记录可见 -> PASS, screenshot: `D:\ProjectPackage\Int\IntRuoyi\yudao-ui-admin-vue3\test-results\edhr-tracking-signature\01-tracking-page.png`
  - tracking: executionCode=BRE202605280518101280040, workOrderId=922108, workOrderCode=EDHR-MO-122-E2E-APPROVE-GATE05280525, batchId=--, batchCode=EDHR-BATCH-122-E2E-APPROVE-GATE05280525, currentNodeName=归档封存, currentAssigneeNames=芋道1, status=3, lastEventType=ARCHIVE_SEAL, lastEventAt=1780903123000, archiveStatus=SEALED
