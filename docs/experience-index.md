...
- Keywords: release-info Git 变更, 版本变更说明最多 10 条, gitChanges, previousCommit..currentCommit, 上一版本 Git 差异 -> `docs/release-build-preflight-lessons.md#2026-07-27-release-info-用户可见-git-变更门禁`
