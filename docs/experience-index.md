...
- Keywords: MES 物料产品选择工艺路线, QA 规程适用范围手动绑定工艺路线, 产品侧路线下拉, getRouteSimpleList, item-binding-list, getRouteItemBindingList, saveRouteProductByItem, getRouteProductByItem, validateRouteNotEnable, PRO_ROUTE_IS_ENABLE, 已启用路线不可维护, 产品侧 route-product 绑定 -> `docs/backend-development.md#mes-工艺路线产品绑定状态门禁`
