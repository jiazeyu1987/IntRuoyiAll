...
- Keywords: DCC 受控打印, 打印申请, 受控打印件, 打印水印, 打印编号, 打印记录, 打印追溯, PRINT 类别规则, DCC 打印权限, DIRECT_PRINTED, dcc:controlled-file:print, controlled-print, 无受控打印权限, 查看打印记录, 最新记录高亮, 副本编号, 直接打印策略, traceability 详情 -> `docs/e2e-rules.md#dcc-受控打印门禁`
