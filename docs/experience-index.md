...
- Keywords: 生产组长报工管理随机数据, team-leader/submission/page, MesTeamLeaderWorkbenchService.getSubmissionPage, MesProProcessPoolTimelineReadMapper, mes_pro_process_pool_event, PRODUCTION_SUBMIT, actual_employee_id, 生产组长责任员工集合, 工序池时间线造数, 只写mes_pro_feedback页面无新增 -> `docs/backend-development.md#第三方报工直报正式链路门禁`
