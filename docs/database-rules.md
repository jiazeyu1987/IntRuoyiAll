...
- Evidence: `doc/tasks/20260727-test-management-deterministic-closed-loop/execution-log.md`；`doc/tasks/20260729-test-release-sql-collation-fix/execution-log.md`；`IntRuoyiBackend/doc/tasks/20260729-release-sql-collation-r2/execution-log.md`。
