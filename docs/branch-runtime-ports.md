...
- Additional worktrees for a profile must use a stable slot in the closed range `1..30`.
- Slots `1..19` keep the existing mapping: worktree port = profile base port + slot.
- Slots `20..30` use the dedicated extension ranges in the table below; they do not enter another profile's base or legacy worktree range.
- Example: `int_batch` slot `2` uses frontend `8043` and backend `48043`.
- Example: `int_main` slot `20` uses frontend `8154` and backend `48154`.
- `slot >= 31` is invalid.
...
| Runtime profile | Slots `1..19` frontend/backend | Slots `20..30` frontend/backend |
| --- | ---: | ---: |
| `int_shedule` | `8022-8040` / `48022-48040` | `8121-8131` / `48121-48131` |
| `int_batch` | `8042-8060` / `48042-48060` | `8132-8142` / `48132-48142` |
| `int_qms` | `8062-8080` / `48062-48080` | `8143-8153` / `48143-48153` |
| `int_main` | `8082-8100` / `48082-48100` | `8154-8164` / `48154-48164` |
| `int_main_d` | `8102-8120` / `48102-48120` | `8165-8175` / `48165-48175` |
...
- Additional worktrees may not use `slot >= 31`, any base port, or any active registry slot/port owned by another worktree.
